...
class MylonRoomDatabaseMigrationTest {

    @get:Rule
    val helper: MigrationTestHelper = MigrationTestHelper(
        InstrumentationRegistry.getInstrumentation(),
        MylonRoomDatabase::class.java,
        listOf(MylonRoomDatabase.DeleteSEMigration()),
    ...
    fun migrateAll() {
        ...
        // for Wallet versions below 106 are broken :/
        ...
        // Room validates and executes all appMigrations.
        Room.databaseBuilder(
            InstrumentationRegistry.getInstrumentation().targetContext,
            MylonRoomDatabase::class.java,
            TestDb
        ).addMigrations(*MylonRoomDatabase.migrations()).build().apply {
