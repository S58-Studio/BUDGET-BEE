...
import com.oneSaver.data.model.primitive.toNonNegative
...
class ExportCsvUseCase @Inject constructor(
    ...
    suspend fun exportCsv(
        ...
        buildString {
            append(MysaveCsvRow.Columns.joinToString(separator = CSV_SEPARATOR))
            append(NEWLINE)
    ...
    private fun MysaveCsvRow.toCsvString(
    ...
    private fun Expense.expenseCsvRow(): MysaveCsvRow = MysaveCsvRow(
        date = time.takeIf
        { settled },
        title = title,
        category = category,
    ...
    private fun Income.incomeCsvRow(): MysaveCsvRow = MysaveCsvRow(
    ...
    private fun Transfer.transferCsvRow(): MysaveCsvRow = MysaveCsvRow(
        date = time.takeIf { settled },
        title = title,
        category = category,
        account = fromAccount,
