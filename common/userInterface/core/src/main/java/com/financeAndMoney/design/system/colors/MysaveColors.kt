package com.financeAndMoney.design.system.colors
...
object MysaveColors {
    ...
    val Green = ColorShades(
        extraLight = Color(0xFFB2EBF2), // A soft, pastel teal
        light = Color(0xFF80DEEA),      // A light, fresh teal
        kindaLight = Color(0xFF4DD0E1), // A medium-light teal
        primary = Color(0xFF26C6DA),    // A vibrant, primary teal
        kindaDark = Color(0xFF00ACC1),  // A deeper teal shade
        dark = Color(0xFF00838F),       // A dark teal for contrast
        extraDark = Color(0xFF005662)   // A very dark teal, almost navy
    )
