package com.financeAndMoney.importdata.csv
...
import com.financeAndMoney.importdata.csv.domain.CSVImporterV2
import com.financeAndMoney.importdata.csv.domain.SAMPLE_SIZE
import com.financeAndMoney.importdata.csv.domain.parseAccount
import com.financeAndMoney.importdata.csv.domain.parseAccountCurrency
import com.financeAndMoney.importdata.csv.domain.parseAmount
import com.financeAndMoney.importdata.csv.domain.parseCategory
import com.financeAndMoney.importdata.csv.domain.parseDate
import com.financeAndMoney.importdata.csv.domain.parseDescription
import com.financeAndMoney.importdata.csv.domain.parseStatus
import com.financeAndMoney.importdata.csv.domain.parseTitle
import com.financeAndMoney.importdata.csv.domain.parseToAccount
import com.financeAndMoney.importdata.csv.domain.parseToAccountCurrency
import com.financeAndMoney.importdata.csv.domain.parseTransactionType
...
class CSVViewModel @Inject constructor(
    ...
    private var amount by mutableStateOf(
        ColumnMapping(
            ivyColumn = "Amount",
            helpInfo = "The amount of the transfers, a positive number. Negative numbers will be made positive.",
            name = "",
            index = -1,
            metadata = 1,
            required = true,
    ...
    private var accountCurrency by mutableStateOf(
        ColumnMapping(
            ...
            helpInfo = """
                ...
                In Mysave App, transfers don't have a currency but inherit
    ...
    private fun handleFinishImport(event: CSVEvent.FinishImport) {
        if (event.launchedFromOnboarding) {
            val importSuccess = (uiState as? UIState.Result)?.importingResults
