...
import com.financeAndMoney.expenseAndBudgetPlanner.userInterface.theme.IvyLight
...
import com.financeAndMoney.legacy.legacyOld.ui.theme.components.CircleButtonFilledGradient
import com.financeAndMoney.legacy.legacyOld.ui.theme.components.CloseButton
import com.financeAndMoney.legacy.utils.lerp
import com.financeAndMoney.expenseAndBudgetPlanner.userInterface.theme.components.ItemIconM
...
import com.financeAndMoney.expenseAndBudgetPlanner.userInterface.theme.pureBlur
...
private fun BoxWithConstraintsScope.UI(
    ...
    val percentExpanded by animateFloatAsState(
        ...
        animationSpec = com.financeAndMoney.legacy.utils.springBounce(),
...
private fun Header(
    ...
    period: com.financeAndMoney.legacy.data.model.TimePeriod,
    ...
    Row(
        ...
        if (!showCloseButtonOnly) {
            ...
            MysaveOutlinedButton(
                ...
                text = period.toDisplayShort(com.financeAndMoney.legacy.mySaveCtx().startDayOfMonth),
            ) {
                onShowMonthModal()
            }
...
private fun Preview_Expense() {
    com.financeAndMoney.legacy.MySavePreview {
        val state = FinPieChartStatisticState(
            ...
            period = com.financeAndMoney.legacy.data.model.TimePeriod.currentMonth(
                startDayOfMonth = 1
            ), // preview
            baseCurrency = "BGN",
            totalAmount = 1828.0,
