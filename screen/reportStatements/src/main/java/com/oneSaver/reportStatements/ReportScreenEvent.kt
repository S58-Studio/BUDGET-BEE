...
sealed class ReportScreenEvent {
    ...
    data class SkipTransactionsLegacy(val transactions: List<com.oneSaver.base.legacy.Transaction>) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class SkipTransactionLegacy(val transaction: com.oneSaver.base.legacy.Transaction) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class OnPayOrGetLegacy(val transaction: com.oneSaver.base.legacy.Transaction) :
        ReportScreenEvent()
}
