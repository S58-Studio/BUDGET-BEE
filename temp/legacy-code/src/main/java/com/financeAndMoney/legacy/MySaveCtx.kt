...
class MySaveCtx @Inject constructor() : MysaveContext() {
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var selectedPeriod: com.financeAndMoney.legacy.data.model.TimePeriod =
        com.financeAndMoney.legacy.data.model.TimePeriod.currentMonth(
    ...
    ): com.financeAndMoney.legacy.data.model.TimePeriod {
        if (!selectedPeriodInitialized || forceReinitialize) {
            selectedPeriod = com.financeAndMoney.legacy.data.model.TimePeriod.currentMonth(
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun updateSelectedPeriodInMemory(period: com.financeAndMoney.legacy.data.model.TimePeriod) {
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var mainTab by mutableStateOf(com.financeAndMoney.legacy.data.model.MainTab.HOME)
        private set

    @Deprecated("Legacy code. Don't use it, please.")
    fun selectMainTab(tab: com.financeAndMoney.legacy.data.model.MainTab) {
        mainTab = tab
    }
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun reset() {
        mainTab = com.financeAndMoney.legacy.data.model.MainTab.HOME
        startDayOfMonth = 1
        isPremium = true
