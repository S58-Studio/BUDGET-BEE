package com.financeAndMoney.expenseAndBudgetPlanner.io.persistence.datastore
...
@Deprecated("legacy - use MySaveDataStore instead")
@Singleton
class MySaveDataStore @Inject constructor(
