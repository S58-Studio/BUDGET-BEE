...
import com.financeAndMoney.design.IVY_COLOR_PICKER_COLORS_FREE
...
import com.financeAndMoney.expenseAndBudgetPlanner.domain.deprecated.logic.csv.model.RowMapping
...
class CSVImporter @Inject constructor(
    ...
    suspend fun import(
        ...
        // Some importers require postprocessing transfers
    ...
    private suspend fun mapToTransaction(
        ...
        if (dateTime == null && dueDate == null) {
            // Cannot save transfers without any date
            return null
        }
    ...
    private fun mapDate(
        ...
        // As a fallback set all transfers 1 year before now
        return timeNowUTC()
            .minusYears(1)
    }
