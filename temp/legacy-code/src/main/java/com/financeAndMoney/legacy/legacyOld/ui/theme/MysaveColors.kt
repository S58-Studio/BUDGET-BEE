package com.financeAndMoney.expenseAndBudgetPlanner.userInterface.theme
...
@Deprecated("Old design system. Use `:financeAndMoney-design` and Material3")
val GradientGreen = Gradient(Green, Color(0xFF00573F))

@Deprecated("Old design system. Use `:financeAndMoney-design` and Material3")
val GradientOrangeRevert = Gradient(Color(0xFFF2CD9E), Orange)

@Deprecated("Old design system. Use `:financeAndMoney-design` and Material3")
val GradientMysave = Gradient(Ivy, Color(0xFFAA99FF))
...
data class Gradient(
    ...
    companion object {
        @Deprecated("Old design system. Use `:financeAndMoney-design` and Material3")
        fun from(gradient: com.financeAndMoney.design.l0_system.Gradient) =
