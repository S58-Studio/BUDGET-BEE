...
import com.financeAndMoney.expenseAndBudgetPlanner.userInterface.theme.components.IvyDividerDot
...
private fun SectionDividerIncomeExpenseRow(
    ...
    Row(
        ...
        if (expenses > 0) {
            ...
            Text(
                text = stringResource(R.string.expenses_lower_case),
        ...
        if (income > 0) {
            ...
            Spacer(modifier = Modifier.width(4.dp))
            Text(
                text = stringResource(R.string.income_lower_case),
                style = UI.typo.c.style(
                    fontWeight = FontWeight.Normal,
                    color = UI.colors.pureInverse
                )
