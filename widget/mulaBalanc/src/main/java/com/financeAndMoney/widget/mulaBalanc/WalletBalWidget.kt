...
import com.financeAndMoney.legacy.utils.shortenAmount
...
class WalletBalanceWidgetReceiver : GlanceAppWidgetReceiver() {
    ...
    @Inject
    lateinit var ivyContext: com.financeAndMoney.legacy.MySaveCtx
    ...
    private fun updateData(context: Context) {
        coroutineScope.launch {
            ...
            val appLocked = com.financeAndMoney.legacy.utils.ioThread {
