package com.financeAndMoney.widget.mulaBalanc
    ...
    Box(
        ...
        Column(
            ...
            if (appLocked) {
                ...
                IncomeXpenseSection(income, expense, currency)
...
fun ButtonsSection(
    ...
    val buttons = listOf(
        R.drawable.ic_income_widget to R.string.income,
        R.drawable.ic_expense_widget to R.string.expense,
        R.drawable.ic_transfer_money_widget to R.string.transfer
    )
    Row(
